...
| Exploitation ops | Contact hypercare défini | `atelier/HYPERCARE-OWNERS-V1.md` (à créer) | Partiel (owners nominatifs validés web, artefact manquant) | À produire en terminal |
...
## Questions ouvertes
- Aucune question bloquante ouverte: signature retenue = PV PDF signé + hash SHA256 archivé.
- Aucune question bloquante ouverte: validation hypercare côté client Aston = Sponsor Delivery + Responsable Qualité.

## Owners nominatifs validés (web)
- Hypercare Aston: Marie Tremblay (Lead Runtime) + Nicolas Gagnon (Lead Plateforme).
- Validation client readiness: Sophie Lavoie (Sponsor Delivery Aston) + Julien Roy (Responsable Qualité).
