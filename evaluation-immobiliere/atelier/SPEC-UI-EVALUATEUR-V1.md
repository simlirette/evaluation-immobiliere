...
| Zone | Données | Action |
|---|---|---|
| Sessions existantes | Sessions runtime locales via `/sessions` et `/review/workbench` | Reprendre un dossier deja execute |
...
## Limites restantes
- L'UI recupere les sessions locales persistees; un registre central de runs longs reels reste a brancher si necessaire.
